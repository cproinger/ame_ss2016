/**
 */
package mm.ManagerModel.util;

import java.util.Map;

import mm.ManagerModel.*;
 ...
 * <!-- end-user-doc -->
 * @see mm.ManagerModel.ManagerModelPackage
 * @generated
 */
public class ManagerModelValidator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final ManagerModelValidator INSTANCE = new ManagerModelValidator();
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "mm.ManagerModel";
	...
	protected EPackage getEPackage() {
	  return ManagerModelPackage.eINSTANCE;
	}
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			case ManagerModelPackage.STATE:
				return validateState((State)value, diagnostics, context);
			case ManagerModelPackage.MANAGER:
				return validateManager((Manager)value, diagnostics, context);
			case ManagerModelPackage.TRANSITION:
				return validateTransition((Transition)value, diagnostics, context);
			case ManagerModelPackage.NAMED_ELEMENT:
	...
	/**
	 * The cached validation expression for the IfProbableThenSum1 constraint of '<em>State</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public boolean validateState_IfProbableThenSum1(State state, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(ManagerModelPackage.Literals.STATE,
				 state,
				 ...
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 "IfProbableThenSum1",
				 STATE__IF_PROBABLE_THEN_SUM1__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
	...
	public boolean validateTransition(Transition transition, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateTransition_EitherRateOrProbability(transition, diagnostics, context);
		return result;
	}

	/**
	 * The cached validation expression for the EitherRateOrProbability constraint of '<em>Transition</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String TRANSITION__EITHER_RATE_OR_PROBABILITY__EEXPRESSION = "rate.oclIsUndefined() xor probability.oclIsUndefined()";

	/**
	 * Validates the EitherRateOrProbability constraint of '<em>Transition</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateTransition_EitherRateOrProbability(Transition transition, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(ManagerModelPackage.Literals.TRANSITION,
				 transition,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 "EitherRateOrProbability",
				 TRANSITION__EITHER_RATE_OR_PROBABILITY__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
