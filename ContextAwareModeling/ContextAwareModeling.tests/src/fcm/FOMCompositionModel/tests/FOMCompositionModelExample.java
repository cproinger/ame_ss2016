...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>FOMCompositionModel</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class FOMCompositionModelExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(FOMCompositionModelPackage.eNS_URI, 
			 FOMCompositionModelPackage.eINSTANCE);
