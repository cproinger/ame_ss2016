...
/**
 * This is the item provider adapter for a {@link mm.ManagerModel.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ManagerModelPackage.Literals.STATE__TRANSITIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(State.class)) {
			case ManagerModelPackage.STATE__TRANSITIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ManagerModelPackage.Literals.STATE__TRANSITIONS,
				 ManagerModelFactory.eINSTANCE.createTransition()));
	}
